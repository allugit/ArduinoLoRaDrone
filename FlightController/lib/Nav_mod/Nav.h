...
/*	for the Digilent CerebotMX4cK board.									*/
/*																		*/
/************************************************************************/
/*  Revision History:													*/
/*																		*/
...
public:
	...
	void ReadRegister(uint8_t bInst, uint8_t bAddr, uint8_t bCntBytes, uint8_t *pData);
	// read and write SPI specific functions - read and write one byte via SPI
	void WriteSPI(uint8_t bInst, uint8_t bAddr, uint8_t bVal);
	uint8_t ReadSPI(uint8_t bInst, uint8_t bAddr);
	...
	void ConfigIntMAG(uint8_t bIntGen, uint8_t bActiveType, bool latch, bool Enable);
	...
	//--------------------------------------------------common functions
	void SetODR(uint8_t bInst, uint8_t odrVal);
	uint8_t GetODRRaw(uint8_t bInstMode);
	float GetODR(uint8_t bInstMode);

	//--------------------------------------------------FIFO specific functions
	void FIFOEnable(uint8_t bInst, bool fEnable);
	void SetFIFO(uint8_t bInstMode, uint8_t parFIFOMode, uint8_t FIFOThreshold);
	uint8_t GetFIFOMode(uint8_t bInst);
	uint8_t GetFIFOThs(uint8_t bInst);
	uint8_t GetFIFOStatus(uint8_t bInst);
};
